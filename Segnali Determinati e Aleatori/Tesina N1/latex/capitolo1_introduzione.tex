...
Osservando l'andamento del segnale in un singolo periodo $T_0$, e centrando l'asse dei tempi, e possibile modellare $y(t)$ come la sovrapposizione lineare di $y_1(t)$ (segnale $\Delta$) e $y_2(t)$ (segnale $\Pi$). Sfruttando la linearità dell'operatore trasformata e le proprietà di queste due funzioni, il calcolo della serie risulta notevolmente semplificato.
...
L'espressione nel periodo $t \in \left[-\frac{T_0}{2}, \frac{T_0}{2}\right]$ risulta essere:
\begin{equation}
...
Sia $\Delta(\cdot)$ che $\Pi(\cdot)$ sono \textbf{funzioni pari}, quindi anche $y(t)$ lo è. I coefficienti $Y_k$ risultano perciò puramente reali (parte immaginaria nulla).
